return {
  ...
  build = function()
    ...
    require("unrealengine.commands").build_engine({ engine_path = "~/Programs/UnrealEngine/" })
  end,
  opts = {
    ...
    engine_path = "/home/Venthryn/Programs/UnrealEngine/", -- Path to your UnrealEngine source directory
